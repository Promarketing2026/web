...
C1. Formulario de Auditoría C.L.A.R.O. (reemplaza a A12, desglosado)
 ...
 [SIGUIENTE] A12d. Redirección post-envío: a /gracias (aplicando ya RETOQUE-4: UTMs capturados en la página del formulario vía sessionStorage, viajando como campos ocultos hacia HubSpot) y luego botón/link al Programador de Reuniones (https://meetings.hubspot.com/promarketing-2026). [código]
