...
en la primera impresión al compartir el link; accesibilidad y límites de plan al final porque no bloquean el lanzamiento)
 ...
 [SIGUIENTE — REQUIERE DECISIÓN DEL USUARIO] HOSTING-1. Resolver el incumplimiento de elegibilidad de Vercel Hobby antes de aprobar producción comercial: elegir Vercel Pro o migrar a un hosting que permita uso comercial. No efectuar gasto ni migración sin aprobación explícita. [infraestructura + decisión]
